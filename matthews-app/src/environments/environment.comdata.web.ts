...
export const environment = {
  ...
  auth_config: {
    ...
    redirect_url: 'http://develop.comdata.rs/MatthewsApp/authorizationcallback',
    end_session_redirect_url: 'http://develop.comdata.rs/MatthewsApp/authorizationcallback',
