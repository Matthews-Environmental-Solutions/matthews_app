...
export const environment = {
  ...
  auth_config: {
    ...
    redirect_url: 'https://matthewsenvironmental.i4connected.cloud/MatthewsApp.Mobile/authorizationcallback',
    end_session_redirect_url: 'https://matthewsenvironmental.i4connected.cloud/MatthewsApp.Mobile/authorizationcallback',
