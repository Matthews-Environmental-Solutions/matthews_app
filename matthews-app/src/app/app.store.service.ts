...
export class AppStoreService extends ComponentStore<AppState> {
    ...
    constructor(private auth: AuthService, private caseService: CaseService, private facilitiesService: FacilityService, private deviceListService: DeviceListService, public modalController: ModalController) {
