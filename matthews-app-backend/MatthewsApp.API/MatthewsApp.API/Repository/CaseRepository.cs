...
public class CaseRepository : BaseRepository<Case, Guid>, ICaseRepository
{
    ...
    public Task SeedDbForDemo(Guid deviceId, string scheduledDeviceAlias)
    {
        ...
        var case1 = new Case
        {
            ...
            ScheduledDeviceAlias = scheduledDeviceAlias,
            ScheduledStartTime = todayAtMidnight.AddDays(0.33),
            ActualDeviceAlias = scheduledDeviceAlias,
        ...
        var case49 = new Case
        {
            ...
            ActualDeviceAlias = scheduledDeviceAlias,
            PerformedBy = "Demo User",
            ScheduledStartTime = DateTime.MinValue,
            Fuel = String.Empty,
            Electricity = String.Empty,
            FacilityStatusId = AwaitingPermissionStatus
        };
